...
export const useSystemSettingsStore = create<SystemSettingsState>((set, get) => ({
  ...
  getCompanyInfo: () => ({
    ...
    phone: get().getSetting<string>('business', 'company_phone', '02382444286'),
    address: get().getSetting<string>('business', 'company_address', 'Unit 9 Northbrook Industrial Estate, Vincent Avenue, Southampton, SO16 6PB'),
  }),
