...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-md border border-slate-300 bg-white px-3 py-2 text-sm whitespace-nowrap",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "focus:bg-slate-100 focus:text-slate-900 hover:bg-slate-50",
