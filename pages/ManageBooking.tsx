...
const PREVIOUS_BOOKINGS: PreviousBooking[] = [
    { id: 'SCP-8921', dateRange: '10 Aug 2023 - 17 Aug 2023', ship: 'Arvia', price: 95.00, status: 'Completed' },
    { id: 'SCP-4429', dateRange: '02 May 2023 - 09 May 2023', ship: 'Iona', price: 95.00, status: 'Completed' },
    { id: 'SCP-1102', dateRange: '14 Dec 2022 - 21 Dec 2022', ship: 'Queen Mary 2', price: 130.00, status: 'Completed' },
];
...
export const ManageBooking: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
        if (reference.toUpperCase().startsWith('SCP')) {
             // Set mock data
             setBooking({
                ...
                trip: {
                    ...
                    returnTime: '09:00',
                    ship: 'Iona',
                    terminal: 'Ocean Cruise Terminal'
                },
                vehicle: {
                    reg: 'AB12 CDE',
                    make: 'Tesla Model Y'
                                ...
                                <div className="flex flex-col md:flex-row gap-8 relative">
                                    ...
                                    <div className="flex-1 relative pl-8 md:pl-0">
                                        ...
                                        <div className="bg-gray-50 p-3 rounded text-sm text-gray-600 flex items-start gap-2">
                                            ...
                                            <span>Unit 9 Northbrook Industrial Estate, Vincent Avenue, Southampton, SO16 6PB</span>
                                        </div>
                                    </div>
                            ...
                            <div className="bg-white rounded-xl shadow-light border border-gray-100 p-6">
                                ...
                                <div className="space-y-3 text-sm">
                                    <div className="flex justify-between">
                                        <span className="text-gray-600">Parking (1 Week)</span>
