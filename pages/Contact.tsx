             ...
             <div className="space-y-6">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="tel:02382444286" className="text-primary font-semibold hover:underline">02382 444286</a>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:info@simplecruiseparking.com" className="text-primary font-semibold hover:underline">info@simplecruiseparking.com</a>
                    </div>
                </div>
