...
export const Home: React.FC = () => {
  return (
    <Layout>
      {/* Hero Section */}
      <section className="bg-primary text-white pt-20 pb-24 md:pb-32 px-4 relative overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 mb-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <FeatureCard 
            icon={<Shield size={32} />}
            title="Safe & Secure"
            text="Fully fenced, CCTV monitored facility with gated access. Your vehicle never leaves our secure compound."
          />
          <FeatureCard 
            icon={<Truck size={32} />}
          ...
          <FeatureCard 
            icon={<Smile size={32} />}
            title="Rated 5 Stars"
            text="Thousands of happy cruisers trust us every year. Check our Google Reviews to see why."
          />
        </div>
      </section>
