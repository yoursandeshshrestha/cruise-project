  ...
  const faqItems = [
    {
        ...
        content: "Yes, we operate a block parking system to ensure maximum security and efficiency within our compound. Your keys are tagged and stored in a secure safe. Your vehicle is only moved by our fully insured professional drivers for parking management or add-on services."
    },
    {
    ...
    },
    {
        ...
        content: "Security is our top priority. Our facility is surrounded by perimeter fencing, monitored by 24/7 CCTV, and has gated access. We also have staff on-site during all operational hours. We have been awarded the Park Mark Safer Parking award."
    },
    {
